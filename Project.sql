...
VALUES 
(1, '123 Fitness St', 'Fitville', 'Florida', 12345),
(2, '456 Nutri Blvd', 'DietTown', 'Tennessee', 67890),
(3, '789 Muscle Ln', 'FlexCity', 'Oregon', 11223),
(4, '101 Bulk Ave', 'Growthville', 'Iowa', 44556),
(5, '121 Shred Rd', 'CutCity', 'North Carolina', 77889),
(6, '394 Health Ct', 'WorkCity', 'New York', 75389),
(7, '843 Shred Blvd', 'Fitville', 'Florida', 69831),
(8, '212 Smoothie Ln', 'EateryCity', 'Pennsylvania', 46686),
(9, '709 Nuts Rd', 'Growthville', 'Iowa', 10058),
(10, '413 Fruit Ave', 'WorkoutTown', 'California', 76309),
(11, '634 Gain Ave', 'Exerciseville', 'New Jersey', 26899),
(12, '914 Fit Blvd', 'MuscleCity', 'Arizona', 15874),
(13, '863 Weight Ln', 'FlexCity', 'Oregon', 46387),
(14, '742 Shred Ct', 'EatTown', 'New Mexico', 95317),
(15, '632 Exercise Ct', 'Fruitville', 'South Dakota', 75214);
...
-- 1. Retreiving the user details along with their fitness goals and their current progress
...
-- 2. Retreiving the user details along with their fitness goals and their current progress
...
SELECT Addresses_T10.*, Sessions_T3.*
FROM Addresses_T10 
